...
import net.damqn4etobg.oresplus.block.custom.RadioactiveGeneratorBlock;
...
public class ModTileEntities {
    ...
    public static RegistryObject<TileEntityType<MegaFusionCrafterTile>> RADIOACTIVE_GENERATOR_TILE =
