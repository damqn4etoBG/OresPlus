...
//        spawnOreInSpecificModBiome(ModBiomes.PURPLE_FUNGUS_PLATEAU_BIOME.get(), OreType.COPPER, event, Dimension.OVERWORLD.toString());
//        spawnOreInSpecificBiome(Biomes.DARK_FOREST, OreType.AMETHYST, event, Dimension.OVERWORLD.toString());
        ...
        spawnOreInAllBiomes(OreType.ALUMINIUM, event, Dimension.OVERWORLD.toString());
        spawnOreInAllBiomes(OreType.ENPOWERED_CRYSTAL, event, Dimension.OVERWORLD.toString());
        spawnOreInSpecificModBiome(ModBiomes.PURPLE_FUNGUS_PLATEAU_BIOME.get(), OreType.URANIUM, event, Dimension.OVERWORLD.toString());
    }
