...
public class RadioactiveGeneratorContainer extends Container {
    ...
    public RadioactiveGeneratorContainer(int windowId, World world, BlockPos pos,
        ...
        if(tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> addSlot(new SlotItemHandler(h, 0, 80, 36)));
        }
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.RADIOACTIVE_GENERATOR.get());
    }
