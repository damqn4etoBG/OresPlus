...
public class FusionCrafterContainer extends Container {
    ...
    public FusionCrafterContainer(int windowId, World world, BlockPos pos,
        ...
        super(ModContainers.FUSION_CRAFTER_CONTAINER.get(), windowId);
        ...
        if(tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h, 0, 26, 42));
                addSlot(new SlotItemHandler(h, 1, 80, 42));
                addSlot(new SlotItemHandler(h, 2, 134, 42));
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.FUSION_CRAFTER.get());
    }
